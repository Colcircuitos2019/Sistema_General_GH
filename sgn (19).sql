...
-- Tiempo de generación: 27-05-2019 a las 19:43:50
...
(1, '1216727816', 1, '2019-05-18 12:09:33', '2019-05-18 18:00:00', 2, 0, 2, 0, '05:50:27', 5),
(2, '1216727816', 1, '2019-05-20 12:10:05', '2019-05-20 16:30:00', 2, 0, 2, 0, '04:19:55', 1),
...
(19, '1216727816', 5, 1, 5, 0, '2018-10-24', NULL),
...
(1, 1, 1, '05:50:27', 1, NULL, '05:50:27', '0'),
(2, 2, 1, '03:39:55', 1, NULL, '03:39:55', '0'),
...
(364, '2019-05-27 06:00:16', 'El dia de hoy 1 llego/aron tarde...', 0, 7, 4);
...
--
ALTER TABLE `dias_festivos`
  MODIFY `iddias_festivos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `notificacion`
  MODIFY `idNotificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=365;
...
--
ALTER TABLE `tablet_piso`
  MODIFY `idtablet_piso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `tiempo_extra`
--
ALTER TABLE `tiempo_extra`
  MODIFY `idtiempo_extra` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `h_laboral`
  ADD CONSTRAINT `fk_H_laboral_Asistencia` FOREIGN KEY (`idAsistencia`) REFERENCES `asistencia` (`idAsistencia`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `tiempo_extra`
  ADD CONSTRAINT `fk_tiempo_extra_Asistencia1` FOREIGN KEY (`idAsistencia`) REFERENCES `asistencia` (`idAsistencia`) ON DELETE NO ACTION ON UPDATE NO ACTION;
